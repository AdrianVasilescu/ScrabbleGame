/*
 * COPIED HERE AS JAR WAS NOT USABLE
 */
package lib.checker.java;
...
public class InMemoryScrabbleWordChecker implements  ScrabbleWordChecker{
    ...
    static {
        try {
            InputStream resourceStream = InMemoryScrabbleWordChecker.class
                    .getResourceAsStream("/lib/checker/resources/collins_scrabble_words_2019.txt");
